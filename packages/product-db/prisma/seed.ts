...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      images: {
        black: '/products/adidas-dame9-black.png',
        blue: '/products/adidas-dame9-blue.png',
    ...
    },
    {
      ...
      images: {
        ...
        purple: '/products/sabrina2-purple.png',
    ...
    },
    {
      ...
      shortDescription: 'Versatile basketball shoe for all positions.',
      description: 'Excellent support, cushioning, and court feel for competitive players.',
      price: 130,
      sizes: ['40', '41', '42', '43', '44', '45'],
      colors: ['white', 'navy', 'black'],
      images: {
        white: '/products/twowxyv5-white.png',
        navy: '/products/twowxyv5-navy.png',
        black: '/products/twowxyv5-black.png',
      },
    ...
    {
      name: 'Converse All Star BB Shift',
      shortDescription: 'Modern performance basketball sneaker.',
      description: 'Designed for speed and agility with Nike-derived cushioning technology.',
      price: 120,
      sizes: ['40', '41', '42', '43', '44'],
      colors: ['black', 'white', 'green'],
      images: {
        black: '/products/bbshift-black.png',
        white: '/products/bbshift-white.png',
        green: '/products/bbshift-green.png',
      },
